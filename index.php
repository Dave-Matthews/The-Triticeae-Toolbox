...
<div id="primaryContentContainer">
  ...
  Agricultural Project</a> (CAP), funded by the National Institute for
  Food and Agriculture (NIFA) of the United States Department of
  Agriculture (USDA). T3 contains SNP, phenotypic, and pedigree data
  from wheat and barley germplasm in the Triticeae CAP.

  <p><b>Participants</b>: The templates for submitting your data about
  phenotype trials, phenotype results, and the lines tested
  are here.
    <br>
