...
/*
 * A preliminary login test to ensure that the user is an admin of the THT before 
 * accessing the phpMyAdmin, this must be placed here beacuse of the 2 sessions.
 */
/*
