...
function load_phenotypes4() {
    $('step4').hide();
    var url = php_self + "?function=step4phenotype&pi=" + phenotype_items_str + "&exps=" + experiments_str + "&lines=" + lines_str + '&subset=' + subset;
    document.title = 'Loading Step1...';
...
function load_phenotypes5() {
    $('step5').hide();
    var url = php_self + "?function=step5phenotype&pi=" + phenotype_items_str + "&exps=" + experiments_str + "&lines=" + lines_str + '&subset=' + subset;
    document.title = 'Loading Step1...';
...
function save_pheno_selection() {
    $('step5').hide();
    var url = php_self + "?function=step5phenotype&pi=" + phenotype_items_str + "&exps=" + experiments_str + '&lw=' + lines_within;
    document.title = 'Loading Step1...';
    var tmp = new Ajax.Updater($('step5'), url, {
        onComplete : function() {
            $('step5').show();
...
function load_lines3() {
    $('step3').hide();
    var url = php_self + "?function=step3lines&exps=" + experiments_str + '&pi=' + phenotype_items_str;
    document.title = 'Loading Step1...';
    var tmp = new Ajax.Updater($('step3'), url, {
        onComplete : function() {
            $('step3').show();
...
function load_lines4() {
    $('step4').hide();
    var url = php_self + "?function=step4lines&exps=" + experiments_str + '&pi=' + phenotype_items_str;
    document.title = 'Loading Step1...';
    var tmp = new Ajax.Updater($('step5'), url, {
        onComplete : function() {
            $('step4').show();
    ...
    if (select1_str == "Phenotypes") {
        ...
        load_markers('', '', 100, 0);
			...
			function use_session(version) {
                ...
                var url=php_self + "?function=download_session_" + version + "&bp=" + breeding_programs_str+'&yrs='+ years_str+'&exps='+experiments_str+'&mm='+mm+'&mmaf='+mmaf;
			...
			function get_download_loc(version) {
			    var mm = $('mm').getValue();
                var mmaf = $('mmaf').getValue();
                var url=php_self + "?function=type2_build_tassel_" + version + "&lines=" + lines_str+'&yrs='+ years_str+'&exps='+experiments_str+'&pi='+phenotype_items_str+'&subset='+subset+'&mm='+mm+'&mmaf='+mmaf;
                document.location = url;
			}
			...
			function getdownload_qtlminer()
			{
			    ...
			    var mm = $('mm').getValue();
                var mmaf = $('mmaf').getValue();
                var url=php_self + "?function=type1build_qtlminer&bp=" + breeding_programs_str+'&yrs='+ years_str+'&t='+selectedTraits()+'&exps='+experiments_str+'&mm='+mm+'&mmaf='+mmaf;
