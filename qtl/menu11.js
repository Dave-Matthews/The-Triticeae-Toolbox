...
function selectDb(parm) {
    ...
    jQuery.ajax({
      type: "GET",
      url: php_self,
      data: "function=displayQTL&pi=" + phenotype_items_str + "&sortby=" + sortBy + "&group=" + groupBy + "&method=" + method,
      success: function(data, textStatus) {
        jQuery("#step3").html(data)
        document.title = title;
      },
...
function group(parm) {
    ...
    jQuery.ajax({
      type: "GET",
      url: php_self,
      data: "function=displayQTL&pi=" + phenotype_items_str + "&sortby=" + sortBy + "&group=" + groupBy + "&imput=" + imput,
      success: function(data, textStatus) {
        jQuery("#step3").html(data)
        document.title = title;
      },
...
function sort(parm) {
    ...
    jQuery.ajax({
      type: "GET",
      url: php_self,
      data: "function=displayQTL&pi=" + phenotype_items_str + "&sortby=" + parm + "&group=" + groupBy,
      success: function(data, textStatus) {
        jQuery("#step3").html(data)
        document.title = title;
      },
