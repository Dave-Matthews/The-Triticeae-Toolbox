...
private function typeExperiments()
	...
	<style type="text/css">
		...
		<form action="curator_data/input_experiments_check.php" method="post" enctype="multipart/form-data">

	<input type="hidden" id="mapsetID" name="MapsetID" value="-1" />
	<p><strong>Means Data File:</strong> <input id="file[]" type="file" name="file[]" size="80%" /> &nbsp;&nbsp;&nbsp;   <a href="curator_data/examples/AB08Aberdeen_Agro_mn_2009_07_24.xls">Example Means Input File</a></p>
	<p><strong>Raw Data File:</strong> <input id="file[]" type="file" name="file[]" size="80%" /> &nbsp;&nbsp;&nbsp;   <a href="curator_data/examples/NDQ06Dormancy_raw_2008_08_27.xls">Example Raw Data File</a></p>
