...
private function typeAnnotations()
	...
	<style type="text/css">
		...
		<form action="curator_data/input_annotations_check.php" method="post" enctype="multipart/form-data">

	<input type="hidden" id="mapsetID" name="MapsetID" value="-1" />
	<p><strong>Annotation File:</strong> <input id="file[]" type="file" name="file[]" size="80%" /> &nbsp;&nbsp;&nbsp;   <a href="curator_data/examples/AB08Aberdeen_Annot_2009_07_24.xls">Example Annotation File</a></p>
