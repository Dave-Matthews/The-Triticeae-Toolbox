      ...
      echo "using $metafile<br>\n";
           ...
           if ($error_flag == 0) {
               ...
               for ($i=3; $i<=$lines_found; $i++) {
                 ...
                 $sql = "insert into csr_fieldbook (experiment_uid, plot, line_name, row_id, column_id, entry, replication, block, subblock, main_plot_tmt, subplot_tmt, check, field_id, note ) values ($fieldbookname,$tmpA,'$tmpB',$tmpC,'$tmpD','$tmpE','$tmpF','$tmpG','$tmpH',$tmpI,$tmpJ,$tmpK,'$tmpL','$tmpM','$tmpN')";
                 $res = mysql_query($sql) or die(mysql_error() . "<br>$sql");
               }
