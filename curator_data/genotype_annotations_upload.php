...
class Annotations {
	...
	<p><strong>Genotype Annotation File:</strong> <input id="file[]" type="file" name="file[]" size="80%" /> &nbsp;&nbsp;&nbsp;   <a href="curator_data/examples/Geno_Annotation_Sample.txt">Example Genotype Annotation File</a></p>
