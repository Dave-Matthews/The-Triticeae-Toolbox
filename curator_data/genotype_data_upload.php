...
class GenotypeData {
    ...
    <br>Due to size of the Genotype Data File, it can be compressed with a "zip" application befor submitting it.<br>
    <p><h4>This upload process may take several hours to complete depending on size of the data file.  Please leave your email adress for us to contact you with the results.</h4></p>
