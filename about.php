...
<div class="section">
  <p>The Triticeae Toolbox (T3) is the web portal for data generated by the <a href="http://triticeaecap.org/" title="">Triticeae Coordinated Agricultural Project</a> (T-CAP), funded by the <a href="http://usda.gov/wps/portal/usda.usdahome">National Institute for Food and Agriculture (NIFA)</a> of the United States Department of Agriculture (USDA).  The database, developed initially as The Hordeum Toolbox (THT) to hold barley data generated by the <a href="http://barleycap.org">Barley CAP</a> project (2006-2010) is being maintained as T3 Barley while a sister database T3 Wheat will hold data generated for <i>Triticum</i> spp.  Both are being enhanced in database performance, community curation and user tools.  T3 contains germplasm line information, pedigree, genotype and phenotypic data from breeding programs participating in the CAP and core germplasm collections maintained by the <a href="http://www.ars.usda.gov/Main/docs.htm?docid=21891">USDA National Small Grains Collection.</a>  </p>
