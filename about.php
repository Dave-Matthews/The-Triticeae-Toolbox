...
<div class="section">
<p>"The Hordeum Toolbox" (THT) is the webportal for the data generated by the <a href="http://barleycap.org/" title="">Barley Coordinated Agricultural Project</a> (CAP) is funded by the Cooperative State Research, Education, and Extension Service (CSREES) of the United States Department of Agriculture (USDA).  THT contains SNP, pedigree, and phenotypic data from breeding germplasm in the Barley CAP.  As a community resource, THT will integrate rapidly expanding SNP data sets with traditional phenotypic data, structural genomics, and <a href="http://www.plexdb.org/" title="">gene expression</a> profile data sets available from PLEXdb. The underlying premise is that these molecular level phenotypes manifest as traits that plant breeders select for.</p>
</div>
...
<tr><td class="strong">Shiaomin Chao</td><td>USDA-ARS Biosciences Research Lab, Fargo, ND</td><td>SNP data production and curation</td></tr>
...
<div class="section">
<p>
<a href="http://bioinf.scri.ac.uk/germinate/wordpress/" title="">SCRI Germinate</a> Development Team (David Marshall, Paul Shaw)<br/>
