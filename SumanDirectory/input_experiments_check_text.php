...
function ForceValue(& $arg1, $msg)
{
 ...
 echo "chck index is". $check_idx . "<br/>";
         ...
         if (1 == mysql_num_rows($res))
         {
            ...
            echo "Fatal Error: experiment '$trial_code' does not exist at row " . $row_num ."<br/><br/>";
						exit("<input type=\"Button\" value=\"Return\" onClick=\"history.go(-1); return;\">");
...
// end of testing recent data 
   	...
   	echo"<br/><br/>";
	?>
	<a href="http://tht.vrac.iastate.edu:8080/SumanDirectory/input_experiments_upload_text.php"> Go Back To Main Page </a>
	<?
