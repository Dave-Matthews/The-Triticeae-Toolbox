...
private function typeExperiments()
	...
	<p><strong>Means Data File:</strong> <input id="file[]" type="file" name="file[]" size="80%" /> &nbsp;&nbsp;&nbsp;   <a href="http://feline.pw.usda.gov/suman/tht/curator_data/examples/Expt_test.txt">Example Means Input File</a></p>
	<p><strong>Raw Data File:</strong> <input id="file[]" type="file" name="file[]" size="80%" /> &nbsp;&nbsp;&nbsp;   <a href="http://feline.pw.usda.gov/suman/tht/curator_data/examples/NDQ06Dormancy_raw_2008_08_27.xls">Example Raw Data File</a></p>
