...
private function typeLineName()
	...
	<style type="text/css">
		...
		<form action="SumanDirectory/input_line_names_check.php" method="post" enctype="multipart/form-data">

	<input type="hidden" id="mapsetID" name="MapsetID" value="-1" />
	<p><strong>File:</strong> <input id="file" type="file" name="file" size="80%" /></p>
