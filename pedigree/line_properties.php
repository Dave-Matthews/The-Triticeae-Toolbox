...
<table id="phenotypeSelTab" class="tableclass1" style="table-layout: fixed; width: 350px;">
  <tr>
    <th width=120px>Category</th>
    <th width=150px>Property/Gene</th>
    <th width=80px>Value/Allele</th>
  </tr>
  <tr class="nohover">
    <td>
      <select name='phenotypecategory' size=5 
